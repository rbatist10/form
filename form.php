		...
		<div class="container" id="inscricao">
			...
			<div class="col-md-6">
				<form method="POST" action="form.php">
					...
					<div class="form-group form-sm">
						<label for="inputAnvisa">você possui certificado da anvisa?</label><br>
						<input type="radio" id="simAnvisa" name="Anvisa" value="simAnvisa">
						<label for="simAnvisa">sim</label>
						<input type="radio" id="naoAnvisa" name="Anvisa" value="naoAnvisa">
						<label for="naoAnvisa">não</label>
					</div>
					<div class="form-group form-sm">
						<label for="tempoMercado">há quanto tempo você está no mercado?</label>
						<input type="text" name="tempoMercado" id="tempoMercado" class="form-control" required />
					</div>
					<div class="form-group form-sm">
						<label for="lojaFisicaOnline">possui loja física e/ou online?</label><br>
						<input type="radio" id="simLoja" name="LojaFisicaOnline" value="simLoja">
						<label for="simLoja">sim</label>
						<input type="radio" id="naoLoja" name="LojaFisicaOnline" value="naoLoja">
						<label for="naoLoja">não</label>
					</div>
					<!-- <div class="form-group form-sm">
						<label for="vendeOutraMaquiagem">vende outras marcas de maquiagem?</label><br>
						<input type="radio" id="simMaquiagem" name="vendeMaquiagem" value="simMaquiagem">
						<label for="simMaquiagem">sim</label>
						<input type="radio" id="naoMaquiagem" name="vendeMaquiagem" value="naoMaquiagem">
						<label for="naoMaquiagem">não</label>
						Qual: <input type="text" name="vendeMaquiagem" id="simMaquiagem" class="form-control">
					</div> -->
					<label for="vendeOutraMaquiagem">vende outras marcas de maquiagem?</label><br><br>
					...
					<div class="form-check form-check-inline">
						<label class="form-check-label" for="inlineRadio3">&nbsp&nbsp Qual: &nbsp</label>
						<input class="form-check-input form-group" type="text" name="inlineRadioOptions" id="inlineRadio3">
					</div>

					<div class="form-group form-sm">
						<label for="localArmazenarProdutos">você possui um local para armazenar os produtos?</label><br>
						<input type="radio" id="simLocal" name="localProdutos" value="simLocal">
						<label for="simLocal">sim</label>
						<input type="radio" id="naoLocal" name="localProdutos" value="naoLocal">
						<label for="naoLocal">não</label>
					</div>
					<div class="form-group form-sm">
						<label for="vendedores">quantos vendedores internos e externos?</label><br>
						<input type="text" id="vendedores" class="form-control" required />
					</div>
